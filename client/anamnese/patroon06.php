                    ...
                    <div class="form-content">
                        ...
                        <div class="form">
                            <div class="questionnaire">
                                ...
                                <div class="question">
                                    <p>- Welke taal spreekt u thuis?</p><textarea rows="1" cols="25" type="text"><?= isset($antwoorden['taal_thuis']) ?></textarea>
                                </div>
                                <div class="question">
                                            ...
                                            <div id="checkfield">
                                                <div class="question">
                                                    <div class="observe"><input type="checkbox" <?= isset($antwoorden['gebruikt_middelen_softdrugs']) ? "checked" : "" ?> name="gebruikt_middelen_softdrugs">
                                                        <p>Softdrugs</p>
                                                    </div><textarea rows="1" cols="25" type="text"><?= isset($antwoorden['gebruikt_middelen_softdrugs_welke']) ?></textarea>
                                                </div>
                                                <div class="question">
                                                    <div class="observe"><input type="checkbox" <?= isset($antwoorden['gebruikt_middelen_harddrugs']) ? "checked" : "" ?> name="gebruikt_middelen_harddrugs">
                                                        <p>Harddrugs</p>
                                                    </div><textarea rows="1" cols="25" type="text"><?= isset($antwoorden['gebruikt_middelen_harddrugs_welke']) ?></textarea>
                                                </div>
                                                <div class="question">
                                                    <div class="observe"><input type="checkbox" <?= isset($antwoorden['gebruikt_middelen_alcohol']) ? "checked" : "" ?> name="gebruikt_middelen_alcohol">
                                                        <p>Alcohol</p>
                                                    </div><textarea rows="1" cols="25" type="text"><?= isset($antwoorden['gebruikt_middelen_alcohol_welke']) ?></textarea>
                                                </div>
                                                <div class="question">
                                                    <div class="observe"><input type="checkbox" <?= isset($antwoorden['gebruikt_middelen_anders']) ? "checked" : "" ?> name="gebruikt_middelen_anders">
                                                        <p>Anders, namelijk:</p>
                                                    </div><textarea rows="1" cols="25" type="text"><?= isset($antwoorden['gebruikt_middelen_anders_welke']) ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <p>
                                ...
                                <div class="question">
                                    <p>- Waar, wanneer, soort pijn?</p><textarea rows="1" cols="25" type="text" name="pijnklachten_waar_wanneer_soort"><?= isset($antwoorden['pijnklachten_waar_wanneer_soort']) ?></textarea>
                                </div>
                                <div class="question">
                                    <p>- Wat doet u doorgaans tegen de pijn?</p><textarea rows="1" cols="25" type="text" name="pijnklachten_tegengaan_pijn"><?= isset($antwoorden['pijnklachten_tegengaan_pijn']) ?></textarea>
                                </div>
                                <div class="question">
                                    <p>- Wat doet u om pijn/ongemak zoveel mogelijk te voorkomen?</p><textarea rows="1" cols="25" type="text" name="pijnklachten_preventie"><?= isset($antwoorden['pijnklachten_preventie']) ?></textarea>
                                </div>
