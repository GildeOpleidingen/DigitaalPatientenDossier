...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_REQUEST['navbutton'])) {
    ...
    if ($result != null) {
        ...
        $result1 = DatabaseConnection::getConn()->prepare("UPDATE `patroon09seksualiteitvoorplanting`
            ...
            WHERE `vragenlijstid`=?");
        if ($result1) {
            $result1->bind_param("isiiiisisiissi", 
                $verandering_seksuele_beleving,
                $verandering_seksuele_beleving_door,
                $verandering_seksueel_gedrag,
                $wisselende_contacten,
                        ...
                        <div class="form">
                            <div class="questionnaire">
                                <div class="question">
                                    ...
                                    <div class="checkboxes">
                                        <div class="question-answer">
                                            <input id="radio" type="radio" value="1" name="verandering_seksuele_beleving" <?= (isset($antwoorden['verandering_seksuele_beleving']) && $antwoorden['verandering_seksuele_beleving'] == '1') ? "checked" : "" ?>>
                                            <label>Ja</label>
                                        ...
                                        <p>
                                            <input type="radio" value="0" name="verandering_seksuele_beleving" <?= (!isset($antwoorden['verandering_seksuele_beleving']) || $antwoorden['verandering_seksuele_beleving'] == '0') ? "checked" : "" ?>>
                                            <label>Nee</label>
                                        </p>
                                    </div>
                                </div>
                                <div class="question">
                                    ...
                                    <div class="checkboxes">
                                        <p>
                                            <input type="radio" value="1" name="verandering_seksueel_gedrag" <?= (isset($antwoorden['verandering_seksueel_gedrag']) && $antwoorden['verandering_seksueel_gedrag'] == '1') ? "checked" : "" ?>>
                                            <label>Ja</label>
                                        </p>
                                        <p>
                                            <input type="radio" value="0" name="verandering_seksueel_gedrag" <?= (!isset($antwoorden['verandering_seksueel_gedrag']) || $antwoorden['verandering_seksueel_gedrag'] == '0') ? "checked" : "" ?>>
                                            <label>Nee</label>
                                        </p>
                                    </div>
                                </div>
                                <div class="question">
                                    ...
                                    <div class="checkboxes">
                                        <p>
                                            <input type="radio" value="1" name="wisselende_contacten" <?= (isset($antwoorden['wisselende_contacten']) && $antwoorden['wisselende_contacten'] == '1') ? "checked" : "" ?>>
                                            <label>Ja</label>
                                        </p>
                                        <p>
                                            <input type="radio" value="0" name="wisselende_contacten" <?= (!isset($antwoorden['wisselende_contacten']) || $antwoorden['wisselende_contacten'] == '0')? "checked" : "" ?>>
                                            <label>Nee</label>
                                        </p>
                                    </div>
                                </div>
                                <div class="question">
                                    ...
                                    <div class="checkboxes">
                                        <p>
                                            <input type="radio" value="1" name="veilig_vrijen" <?= (isset($antwoorden['veilig_vrijen']) && $antwoorden['veilig_vrijen'] == '1') ? "checked" : "" ?>>
                                            <label>Ja</label>
                                        </p>
                                        <p>
                                            <input type="radio" value="0" name="veilig_vrijen" <?= (!isset($antwoorden['veilig_vrijen']) || $antwoorden['veilig_vrijen'] == '0')? "checked" : "" ?>>
                                            <label>Nee</label>
                                        </p>
                                    </div>
                                </div>
                                <div class="question">
                                    ...
                                    <div class="checkboxes">
                                        <div class="question-answer">
                                            <input id="radio" type="radio" value="1" name="anticonceptiemiddel" <?= (isset($antwoorden['anticonceptiemiddel']) && $antwoorden['anticonceptiemiddel'] == '1') ? "checked" : "" ?>>
                                            <label>Ja</label>
                                        ...
                                        <p>
                                            <input type="radio" value="0" name="anticonceptiemiddel" <?= (!isset($antwoorden['anticonceptiemiddel']) || $antwoorden['anticonceptiemiddel'] == '0') ? "checked" : "" ?>>
                                            <label>Nee</label>
                                        </p>
                                    </div>
                                </div>
                                <div class="question">
                                    ...
                                    <div class="checkboxes">
                                        <p>
                                            <input type="radio" value="1" name="anticonceptiemiddel_problemen" <?= (isset($antwoorden['anticonceptiemiddel_problemen']) && $antwoorden['anticonceptiemiddel_problemen'] == '1') ? "checked" : "" ?>>
                                            <label>Ja</label>
                                        </p>
                                        <p>
                                            <input type="radio" value="0" name="anticonceptiemiddel_problemen" <?= (!isset($antwoorden['anticonceptiemiddel_problemen']) || $antwoorden['anticonceptiemiddel_problemen'] == '0') ? "checked" : "" ?>>
                                            <label>Nee</label>
                                        </p>
                                    </div>
                                </div>
                                <div class="question">
                                    ...
                                    <div class="observation">
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= (isset($boolArrayGerichtheid[0]) && $boolArrayGerichtheid[0] == '1') ? "checked" : "" ?> name="gerichtheid1">
                                                <p>Heteroseksueel</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= (isset($boolArrayGerichtheid[1])  && $boolArrayGerichtheid[1] == '1') ? "checked" : "" ?> name="gerichtheid2">
                                                <p>Biseksueel</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= (isset($boolArrayGerichtheid[2])  && $boolArrayGerichtheid[2] == '1') ? "checked" : "" ?> name="gerichtheid3">
                                                <p>Homoseksueel</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="question">
                                    ...
                                    <div class="checkboxes">
                                        <p>
                                            <input type="radio" value="1" name="seksuele_gerichtheid_problemen" <?= (isset($antwoorden['seksuele_gerichtheid_problemen']) && $antwoorden['seksuele_gerichtheid_problemen'] == '1') ? "checked" : "" ?>>
                                            <label>Ja</label>
                                        </p>
                                        <p>
                                            <input type="radio" value="0" name="seksuele_gerichtheid_problemen" <?= (!isset($antwoorden['seksuele_gerichtheid_problemen']) || $antwoorden['seksuele_gerichtheid_problemen'] == '0') ? "checked" : "" ?>>
                                            <label>Nee</label>
                                        </p>
                                    </div>
                                </div>
                                <div class="question">
                                    ...
                                    <div class="checkboxes">
                                        <div class="question-answer">
                                            <input id="radio" type="radio" value="1" name="soa" <?= (isset($antwoorden['soa']) && $antwoorden['soa'] == '1') ? "checked" : "" ?>>
                                            <label>Ja</label>
