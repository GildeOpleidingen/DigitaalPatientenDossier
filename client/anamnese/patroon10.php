                            ...
                            <div class="questionnaire">
                                <div class="question">
                                    ...
                                    <div class="observation">
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[0]) ? "checked" : "" ?> name="reactie1">
                                                <p>Zoveel mogelijk vermijden</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[1]) ? "checked" : "" ?> name="reactie2">
                                                <p>Drugs gebruiken</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[2]) ? "checked" : "" ?> name="reactie3">
                                                <p>Ontwikkeling van lichamelijke symptomen</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[3]) ? "checked" : "" ?> name="reactie4">
                                                <p>Medicatie</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[4]) ? "checked" : "" ?> name="reactie5">
                                                <p>Meer/minder eten</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[5]) ? "checked" : "" ?> name="reactie6">
                                                <p>Agressie</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[6]) ? "checked" : "" ?> name="reactie7">
                                                <p>Praten met anderen</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[7]) ? "checked" : "" ?> name="reactie8">
                                                <p>Alcohol drinken</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[8]) ? "checked" : "" ?> name="reactie9">
                                                <p>Houd mijn gevoelens voor me</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[9]) ? "checked" : "" ?> name="reactie10">
                                                <p>Slapen/terugtrekken</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[10]) ? "checked" : "" ?> name="reactie11">
                                                <p>Vertrouwen op religie</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[11]) ? "checked" : "" ?> name="reactie12">
                                                <p>Zo goed mogelijk zelf oplossen</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayReacties[12]) ? "checked" : "" ?> name="reactie13">
                                                <p>Anders, namelijk:</p>
                                            </div><textarea rows="1" cols="25" type="text"><?= isset($antwoorden['reactie_anders']) ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="question">
                                ...
                                <div class="question">
                                    <p>- Met wie bespreekt u uw gevoelens c.q. problemen?</p><textarea rows="1" cols="25" type="text" name="bespreken_gevoelens_met"><?= isset($antwoorden['bespreken_gevoelens_met']) ?></textarea>
                                </div>
