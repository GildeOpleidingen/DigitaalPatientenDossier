            ...
            <div class="pages">4. Activiteitenpatroon</div>
                <div class="form">
                    <div class="questionnaire">
                        ...
                        <div class="question"><div class="observe"><input type="checkbox" name="voedingCheckbox" <?php if(isset($antwoorden['voeding']) == "0" || isset($antwoorden['voeding']) > 0) { echo "checked"; } ?>><p>Voeding</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['voeding'])?>" name="voeding"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="aankledenCheckbox" <?php if(isset($antwoorden['aankleden']) == "0" || isset($antwoorden['aankleden']) > 0) { echo "checked"; } ?>><p>Aankleden</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['aankleden']) ?>" name="aankleden"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="alg_mobiliteitCheckbox" <?php if(isset($antwoorden['alg_mobiliteit']) == "0" || isset($antwoorden['alg_mobiliteit']) > 0) { echo "checked"; } ?>><p>Algemene mobiliteit</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['alg_mobiliteit']) ?>" name="alg_mobiliteit"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="kokenCheckbox" <?php if(isset($antwoorden['koken']) == "0" || isset($antwoorden['koken']) > 0) { echo "checked"; } ?>><p>Koken</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['koken']) ?>" name="koken"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="huishoudenCheckbox" <?php if(isset($antwoorden['huishouden']) == "0" || isset($antwoorden['huishouden']) > 0) { echo "checked"; } ?>><p>Huishouden</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['huishouden']) ?>" name="huishouden"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="financienCheckbox" <?php if(isset($antwoorden['financien']) == "0" || isset($antwoorden['financien']) > 0) { echo "checked"; } ?>><p>Financiën</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['financien'])  ?>" name="financien"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="verzorgingCheckbox" <?php if(isset($antwoorden['verzorging']) == "0" || isset($antwoorden['verzorging']) > 0) { echo "checked"; } ?>><p>Verzorging</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['verzorging'])  ?>" name="verzorging"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="badenCheckbox" <?php if(isset($antwoorden['baden']) == "0" || isset($antwoorden['baden']) > 0) { echo "checked"; } ?>><p>Baden</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['baden']) ?>" name="baden"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="toiletgangCheckbox" <?php if(isset($antwoorden['toiletgang']) == "0" || isset($antwoorden['toiletgang']) > 0) { echo "checked"; } ?>><p>Toiletgang</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['toiletgang']) ?>" name="toiletgang"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="uit_bed_komenCheckbox" <?php if(isset($antwoorden['uit_bed_komen']) == "0" || isset($antwoorden['uit_bed_komen']) > 0) { echo "checked"; } ?>><p>Uit bed komen</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['uit_bed_komen']) ?>" name="uit_bed_komen"></div>
                        <div class="question"><div class="observe"><input type="checkbox" name="winkelenCheckbox" <?php if(isset($antwoorden['winkelen']) == "0" || isset($antwoorden['winkelen']) > 0) { echo "checked"; } ?>><p>Winkelen</p></div><input type="number" min="0" max="4" value="<?= isset($antwoorden['winkelen']) ?>" name="winkelen"></div>
