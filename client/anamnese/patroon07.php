                    ...
                    <div class="form-content">
                        ...
                        <div class="question"><p>- Hoe voelt u zich op dit moment?</p> 
                            <div class="observation">
                                ...
                                <div class="question"><div class="observe"><input type="checkbox" <?= isset($boolArrayGevoelOpDitMoment[9]) ? "checked" : "" ?> name="gevoel10"><p>Anders, namelijk:</p></div><textarea  rows="1" cols="25" type="text"><?= isset($antwoorden['anders']) ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="question">
                                ...
                                <div class="question">
                                    ...
                                    <div class="observation">
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayGevoelMomenteel[0]) ? "checked" : "" ?> name="gevoelMomenteel1">
                                                <p>Sterk</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayGevoelMomenteel[1]) ? "checked" : "" ?> name="gevoelMomenteel2">
                                                <p>Zwak</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayGevoelMomenteel[2]) ? "checked" : "" ?> name="gevoelMomenteel3">
                                                <p>Krachteloos</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="question">
                                    ...
                                    <div class="observation">
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayLichamelijkeEnergie[0]) ? "checked" : "" ?> name="lichamelijkeEnergie1">
                                                <p>Genoeg</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayLichamelijkeEnergie[1]) ? "checked" : "" ?> name="lichamelijkeEnergie2">
                                                <p>Te veel</p>
                                            </div>
                                        </div>
                                        <div class="question">
                                            <div class="observe"><input type="checkbox" <?= isset($boolArrayLichamelijkeEnergie[2]) ? "checked" : "" ?> name="lichamelijkeEnergie3">
                                                <p>Te weinig</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="observation">
                                    ...
                                    <div class="question">
                                        <div class="observe"><input type="checkbox" <?= isset($boolArrayObservatie[11]) ? "checked" : "" ?> name="observatie12">
                                            <p>Matige machteloosheid</p>
                                        </div>
                                    </div>
                                    <div class="question">
                                        <div class="observe"><input type="checkbox" <?= isset($boolArrayObservatie[12]) ? "checked" : "" ?> name="observatie13">
                                            <p>Ernstige machteloosheid</p>
                                        </div>
                                    </div>
                                    <div class="question">
                                        <div class="observe"><input type="checkbox" <?= isset($boolArrayObservatie[13]) ? "checked" : "" ?> name="observatie14">
                                            <p>Geringe zelfachting</p>
                                        </div>
                                    </div>
                                    <div class="question">
                                        <div class="observe"><input type="checkbox" <?= isset($boolArrayObservatie[14]) ? "checked" : "" ?> name="observatie15">
                                            <p>Chronisch geringe zelfachting</p>
                                        </div>
                                    </div>
                                    <div class="question">
                                        <div class="observe"><input type="checkbox" <?= isset($boolArrayObservatie[15]) ? "checked" : "" ?> name="observatie16">
                                            <p>Reactief geringe zelfachting</p>
                                        </div>
                                    </div>
                                    <div class="question">
                                        <div class="observe"><input type="checkbox" <?= isset($boolArrayObservatie[16]) ? "checked" : "" ?> name="observatie17">
                                            <p>Verstoord lichaamsbeeld</p>
                                        </div>
                                    </div>
                                    <div class="question">
                                        <div class="observe"><input type="checkbox" <?= isset($boolArrayObservatie[17]) ? "checked" : "" ?> name="observatie18">
                                            <p>Hopeloosheid</p>
                                        </div>
                                    </div>
                                    <div class="question">
                                        <div class="observe"><input type="checkbox" <?= isset($boolArrayObservatie[18]) ? "checked" : "" ?> name="observatie19">
