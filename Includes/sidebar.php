...
<html>
	...
	<body>
            ...
            $result = DatabaseConnection::getConn()->query("SELECT naam, geboortedatum, reanimatiestatus FROM client WHERE id = '$id'");
