...
<div class="sidebar">
    ...
    <div class="profile">
        <div class="profile-img">
            <?php
            if ($row1[13] != null) {
                echo "<img src='data:image/jpeg;base64, " . base64_encode($row1[13]) . "' alt='profile picture'>";
            } else {
        ...
        <div class="personal-information">
            <p><?php echo $row1[0]; ?></p>
            <p id="birth"><?php
                echo date_create($row1[8])->format('d-m-Y');
                $geboortedatum = $row1[8];
                $vandaag = date("Y-m-d");
