        ...
        <form id="patientForm" method="POST">
            ...
            <div class="bloeddrukken">
                <div class="bloeddruk-lengte">
                    ...
                    <input type="text" id="bloeddruk" name="bloeddruk" placeholder="Hoog" required min="0" max="140"> <!-- o tot 140 -->
                </div>
                <div class="bloeddruk-lengte">
                    <label for="Bloed druk">Bloeddruk Laag:</label>
                    <input type="text" id="bloeddruk2" name="bloeddruk2" placeholder="Laag" required min="0" max="140"> <!-- o tot 140 -->
                </div>
            </div>
