...
if ($result != null) {
    ...
    $result1 = DatabaseConnection::getConn()->prepare("UPDATE `patroon02voedingstofwisseling`
            ...
            `observatie`=?
            WHERE `vragenlijstid`=?");
    $result1->bind_param("iisiiiiiisi", $eetlust, $dieet, $dieetWelk, $gewichtVerandert, $moeilijkSlikken, $gebitsProblemen, $gebitsProthese, $huidProblemen, $gevoel, $observatie, $vragenlijstId);
    $result1->execute();
