...
function checkIfClientExistsByName(string $naam): bool {
    $result = getClientByName($naam);

    return sizeof((array) $result) > 0;
}

function getClientById($id): array|null {
...
function getClientByName($name): array|null {
